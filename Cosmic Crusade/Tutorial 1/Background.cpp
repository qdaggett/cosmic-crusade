...
void Background::Initialize()
{
	...
	win.loadTexture(TextureType::Diffuse, "Textures/Victory.png");
...
void Background::mainMenu()
{
	...
	back1.setLocation(0, -7, -1);

	back2.setLocation(0, 68, -1);
}
...
void Background::gameOver()
{
	...
	back1.setLocation(0, -7);
	back2.setLocation(0, 68);
...
void Background::update()
{
	...
	{
		back1.setLocation(0, 75, -1);
	}

	if (back2.location.y <= -75)
	{
		back2.setLocation(0, 75, -1);
	}
}
